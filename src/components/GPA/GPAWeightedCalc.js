      ...
      <form onSubmit={handleSubmit}>
        <ul>
          <li>
            ...
            <input type="number" id="current-gpa" min="2" max="5.0" onChange={handleChange} value={currentGPA} step="0.1" required></input>
          </li>
          <li>
            <div className="label-and-help-container">
          ...
          <li>
            ...
            <input type="number" id="desired-gpa" min="2" max="5.0" onChange={handleChange} value={desiredGPA} step="0.1" required></input>
          </li>
          <li>
            <div className="label-and-help-container">
